...
CREATE TABLE TRANSACTIONS (
    ...
    CONSTRAINT tr_direction_fk FOREIGN KEY (DIRECTION_ID) REFERENCES DIRECTION (DIRECTION_ID),
...
DATAFILE 'C:\Users\ivanr\Oracle\tb/userdata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 2G;
...
DATAFILE 'C:\Users\ivanr\Oracle\tb/productdata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 3G;
...
DATAFILE 'C:\Users\ivanr\Oracle\tb/transactiondata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 4G;
...
DATAFILE 'C:\Users\ivanr\Oracle\tb/cardata.dbf'
SIZE 500M 
AUTOEXTEND ON 
NEXT 50M 
MAXSIZE 5G;
...
BEGIN
    IF :NEW.USER_ID IS NULL THEN
        SELECT IVANYVELEZ.USERS_SEQ.NEXTVAL INTO :NEW.USER_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PRODUCT_ID IS NULL THEN
        SELECT IVANYVELEZ.PRODUCTS_SEQ.NEXTVAL INTO :NEW.PRODUCT_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PAY_ID IS NULL THEN
        SELECT IVANYVELEZ.PAYS_SEQ.NEXTVAL INTO :NEW.PAY_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.DIRECTION_ID IS NULL THEN
        SELECT IVANYVELEZ.DIRECTIONS_SEQ.NEXTVAL INTO :NEW.DIRECTION_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.TRANSACTION_ID IS NULL THEN
        SELECT IVANYVELEZ.TRANSACTIONS_SEQ.NEXTVAL INTO :NEW.TRANSACTION_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.TP_ID IS NULL THEN
        SELECT IVANYVELEZ.TRPR_SEQ.NEXTVAL INTO :NEW.TP_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.CAR_ID IS NULL THEN
        SELECT IVANYVELEZ.CARS_SEQ.NEXTVAL INTO :NEW.CAR_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.CP_ID IS NULL THEN
        SELECT IVANYVELEZ.CARPR_SEQ.NEXTVAL INTO :NEW.CP_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.ADMINISTRATOR_ID IS NULL THEN
        SELECT IVANYVELEZ.ADMINISTRATORS_SEQ.NEXTVAL INTO :NEW.ADMINISTRATOR_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.DEPARTMENT_ID IS NULL THEN
        SELECT IVANYVELEZ.DEPARTMENTS_SEQ.NEXTVAL INTO :NEW.DEPARTMENT_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.GENRE_ID IS NULL THEN
        SELECT IVANYVELEZ.GENRES_SEQ.NEXTVAL INTO :NEW.GENRE_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.PURCHASING_STATUS_ID IS NULL THEN
        SELECT IVANYVELEZ.PURCHASING_STATUS_SEQ.NEXTVAL INTO :NEW.PURCHASING_STATUS_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.BANKING_ENTITY_ID IS NULL THEN
        SELECT IVANYVELEZ.BANKING_ENTITIES_SEQ.NEXTVAL INTO :NEW.BANKING_ENTITY_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.NEWS_ID IS NULL THEN
        SELECT IVANYVELEZ.NEWS_SEQ.NEXTVAL INTO :NEW.NEWS_ID FROM DUAL;
    END IF;
END;
...
BEGIN
    IF :NEW.COMMISSIONS_ID IS NULL THEN
        SELECT IVANYVELEZ.COMMISSIONS_SEQ.NEXTVAL INTO :NEW.COMMISSIONS_ID FROM DUAL;
    END IF;
END;
