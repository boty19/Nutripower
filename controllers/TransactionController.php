        ...
        public function decreaseQuantity(){
            ...
            if(isset($_GET)){
                ...
                if($idProduct){
                    ...
                    if($resultado){
                        /*Redirigir*/
                        header("Location:"."http://localhost/NutriPower/?controller=transactionController&action=windowCar");
                    /*De lo contrario*/
                    }else{
                        /*Crear la sesion y redirigir a la ruta pertinente*/
                    ...
                    foreach($list as $listCar){
                        ...
                        if($id_transaction && $created_at2){
                            ...
                            if($resultado2 != false){
                                ...
                                /*Redirigir*/
                                header("Location:"."http://localhost/NutriPower/?controller=productController&action=windowProducts");
                            /*De lo contrario*/  
                            }else{
                                /*Crear la sesion y redirigir a la ruta pertinente*/
